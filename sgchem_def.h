...
#ifndef ABHE
#if defined(SWEEP_HYDROGEN_ONLY) || defined(HYDROGEN_ONLY)
#define ABHE 0.0
...
#define SGCHEM_NUM_SPECIES 4
#define SGCHEM_NUM_ADVECTED_SPECIES 7
#define SGCHEM_NUM_THERMAL_RATES 24
#define IH2 0
#define IHP 1
#define ICO 2
#define IHEP 3
...
/* Size of photorates_direct array, used to pass rates from RT to
 * chemistry backend */
#define NDIRECT 8
